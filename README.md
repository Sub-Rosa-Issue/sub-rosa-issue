...
```bash
pnpm install
pnpm contract:test          # contract test suite
pnpm sdk:test               # SDK test suite
pnpm tlock:test             # timelock package test suite
pnpm keeper:test            # keeper service test suite
pnpm web:test               # web application test suite
...
- [x] Round contract + on-chain Drand BLS (`pnpm contract:test`)
- [x] tlock + auditor blob (`pnpm tlock:test`)
- [x] SDK + optional OZ Relayer Channels submitter (`pnpm sdk:test`)
